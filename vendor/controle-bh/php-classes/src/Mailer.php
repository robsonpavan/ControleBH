...
class Mailer {
    ...
    const NAME_FROM = "Drive Celepar";

    const USERNAME2 = "drivecelepar";
    const PASSWORD2 = "tUg6oPoP3ikffQ==";
    ...
    public function __construct($toAddress, $toName, $subject, $tplName, $data = array()) {
        ...
        //$this->mail->Host = 'expressoMX.pr.gov.br';
        $this->mail->Port = 587;
        //$this->mail->Port = 25;
        //Set the encryption system to use - ssl (deprecated) or tls
        //$this->mail->SMTPSecure = 'tls';
        //HABILITYAR LINHA DE CIMA PARA GMAIL-------------------
